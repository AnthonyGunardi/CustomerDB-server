...
class CustomerController {
  static async create(req, res, next) {
    try {
      ...
      const { fullname, company, address, phone, email, birthday, product, note, division_id } = req.body;
      ...
      const newCustomer = await Customer.create(
        { fullname, company, address, phone, email, birthday, product, note, division_id, user_id: user.id }
      );
